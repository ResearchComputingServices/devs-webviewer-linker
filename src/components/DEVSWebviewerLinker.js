...
export class DEVSWebviewerLinker {
    ...
    showIcon = (svg, id) => {
        ...
        return `
            <svg id="${id}" class="${hasAssociation ? 'invisible' : 'visible'} warning-icon position-absolute end-0 bottom-0" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-exclamation-triangle" viewBox="0 0 16 16">
